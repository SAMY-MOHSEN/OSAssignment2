...
public class RoundRobinSchedule extends ScheduleTechnique {
    ...
    private double roundRobinQuantum;
    public RoundRobinSchedule(List<MProcess> processes, int contextSwitching, double roundRobinQuantum) {
        super();
...
//        readyQueue.sort((o1, o2) -> (int) (o1.getArrivalTime() - o2.getArrivalTime()));
    ...
    public void run() {
        MProcess head;
        double round_robin_time = roundRobinQuantum;
        ...
        while (!allFinished()) {
            ...
            if (head.getRealTimeBurstTime() >= head.getBurstTime()) {
                ...
                readyQueue.remove(0);
                round_robin_time = roundRobinQuantum;
